...
public class ReadPacketByOrder {
    ...
    private static final String FILE="xunlei_";
    private static int ORDER=18;
    private static int COUNT=21;
    private static String PCAP_FILE
            = System.getProperty(PCAP_FILE_KEY, "H:/xunlei/"+FILE+ORDER+"_down.pcap");
    private static String PCAP_FILE1
            = System.getProperty(PCAP_FILE_KEY, "H:/xunlei/"+FILE+ORDER+"_up.pcap");
    private ReadPacketByOrder() {}
    public static void main(String[] args) throws PcapNativeException, NotOpenException {
        for (int n = 0; n < COUNT; n++) {
            PCAP_FILE = System.getProperty(PCAP_FILE_KEY, "H:/xunlei/"+FILE+ORDER+"_down.pcap");
            PCAP_FILE1 = System.getProperty(PCAP_FILE_KEY, "H:/xunlei/"+FILE+ORDER+"_up.pcap");
            PcapHandle handle;
            PcapHandle handle1;
            double sum = 0;
            double sum1 = 0;
